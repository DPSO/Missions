...
_regEnySide = independent;                     //Units of this side will be classed as regular enemies and will share information about detected units across entire map (Side: can be east, west, independent) - if you don't need this, use sideEmpty.
...
_incogFactions = ["OPF_G_F","IND_C_F"]; //Array of enemy factions whose items and vehicles will allow the player to impersonate the enemy
...
_civWpnArray = ["rhs_weap_m16a4_carryhandle","rhsusf_M61A2","rhs_weap_m16a4_carryhandle_M203 "];
