...
force ace_medical_maxReviveTime = 480;
...
adv_aceSplint_patientCondition = 1;
...
dzn_Flares_H_ListSetting = "StaticCannon";
...
dzn_EJAM_dud_ChanceSettings = 30;
dzn_EJAM_fail_to_eject_ChanceSettings = 20;
dzn_EJAM_fail_to_extract_ChanceSettings = 20;
dzn_EJAM_feed_failure_2_ChanceSettings = 20;
dzn_EJAM_feed_failure_ChanceSettings = 30;
dzn_EJAM_Force = true;
dzn_EJAM_ForceOverallChance = true;
dzn_EJAM_MappingSettings = "[""arifle_MX_F"",0.05,45,10,45,0,0]";
dzn_EJAM_OverallChanceSetting = 0.01;
dzn_EJAM_SubsonicJamEffectSetting = "20";
...
force MRH_MilsimTools_FireSupport_CASPlanesBluFor = "CUP_B_A10_DYN_USA_OCimport_02,CFP_B_USMC_AV_8B_Harrier_II_DES_01,CFP_B_USMC_F35B_Lightning_II_DES_01";
...
force MRH_MilsimTools_FireSupport_CASShots = "10";
...
force MRH_MilsimTools_HaloGear_missionConfiguredProtectiveGear = "mask_halo,halo_mask";
...
force MRH_MilsimTools_BluForHelis = "CUP_B_UH60M_US";
...
force MRH_MilsimTools_InsertionHandler_SupplyPlanesBluFor = "CFP_B_USMC_C130J_DES_01";
...
force MRH_MilsimTools_FireSupport_NumberOfSuppliesDrops = "300";
...
force MRH_MilsimTools_FireSupport_Supplies_DistanceForAircraft = "2500";
force MRH_MilsimTools_FireSupport_Supplies_isCustomConditionSet = true;
force MRH_MilsimTools_FireSupport_Supplies_ListOfAvailableSupplies = "FlexibleTank_01_forest_F,B_CargoNet_01_ammo_F,Box_NATO_AmmoVeh_F,ACE_medicalSupplyCrate_advanced,ACE_Box_Misc,ACE_Box_Ammo,KAT_medicalSupplyCrate,MRH_MedicalTent,CUP_USBasicAmmunitionBox_EP1,CUP_USBasicAmmunitionBox,CUP_USOrdnanceBox,CUP_USOrdnanceBox_EP1,B_supplyCrate_F,CUP_USVehicleBox,CUP_USVehicleBox_EP1,Box_mas_usl_Sup_F,Box_NATO_Support_F,CUP_USLaunchers_EP1,CUP_USLaunchersBox,Box_NATO_AmmoOrd_F,Box_NATO_Equip_F,CUP_USBasicWeaponsBox,CUP_USBasicWeapons_EP1,ACE_Box_Ammo,ACE_Box_Chemlights,ACE_Box_Misc";
force MRH_MilsimTools_FireSupport_Supplies_useSupplyDrops = true;
force MRH_MilsimTools_FireSupport_SupplyPlanesBluFor = "CFP_B_USMC_C130J_DES_01,CFP_B_USMC_MV_22B_Osprey_DES_01";
...
BLU_T_F = true;
CFP_B_AFARMY = true;
CFP_B_AFGPOLICE = true;
CFP_B_CAF = true;
CFP_B_CDF_SNW = true;
CFP_B_CZARMY_WDL = true;
CFP_B_DEARMY_WDL = true;
CFP_B_GBARMY_WDL = true;
CFP_B_ILIDF = true;
CFP_B_IQARMY = true;
CFP_B_IQPOLICE = true;
CFP_B_KEARMY = true;
...
CFP_B_PESH = true;
CFP_B_SDARMY = true;
CFP_B_SDMilitia = true;
CFP_B_UGARMY = true;
CFP_B_USARMY_WDL = true;
CFP_B_USCIA = true;
CFP_B_USMC_DES = true;
CFP_B_USRANGERS_WDL = true;
CFP_B_USSEALS_DES = true;
CFP_B_USSEALS_WDL = true;
CFP_B_YPG = true;
CFP_C_AFG = true;
CFP_C_AFRCHRISTIAN = true;
CFP_C_AFRISLAMIC = true;
CFP_C_ASIA = true;
CFP_C_ME = true;
CFP_I_ALNUSRA = true;
CFP_I_IS = true;
...
CFP_I_SSArmy = true;
CFP_I_TUAREG = true;
CFP_I_WestUltra = true;
CFP_O_ABUSAYYAF = true;
CFP_O_ALQAEDA = true;
CFP_O_ALSHABAAB = true;
CFP_O_ANSARALLAH = true;
CFP_O_BOKOHARAM = true;
CFP_O_CFRebels = true;
CFP_O_CHDKZ_SNW = true;
CFP_O_HAMAS = true;
CFP_O_HEZBOLLAH = true;
CFP_O_IRARMY = true;
CFP_O_IS = true;
CFP_O_NKARMY = true;
CFP_O_RUARMY_DES = true;
CFP_O_RUMVD = true;
CFP_O_SDRebels = true;
CFP_O_SOREBEL = true;
CFP_O_SSREBELS = true;
...
force TFAR_globalRadioRangeCoef = 1.999;
