...
/*     player synchronizeObjectsAdd [TransportRequester];
    TransportRequester synchronizeObjectsAdd [player];

    player synchronizeObjectsAdd [AmmoRequester];
    AmmoRequester synchronizeObjectsAdd [player]; */


    // [player, TransportRequester, TransportProvider] call BIS_fnc_addSupportLink;
    // [player, AmmoRequester, AmmoProvider] call BIS_fnc_addSupportLink;
