...
force ace_medical_blood_bloodLifetime = 360;
...
diwako_ragdoll_server_only = false;
...
// Lambs Quick Actions
force lambs_quickActions_add_detonator = true;
force lambs_quickActions_add_fast_rope = true;

// LOGIC
force LOG_AIDISTANCEVEHPATH = 100;
force LOG_AIMagLimit = 3;
force LOG_ARTI = 300;
force LOG_ARTILLERY = true;
force LOG_FORMATION = true;
force LOG_GARDIS = 700;
force LOG_HEARINGDISTANCE = 800;
force LOG_LOG = 1;
force LOG_MEDIC = true;
force LOG_MINESDIS = 500;
force LOG_QUICKKILL = true;
force LOG_QUICKKILLLIMIT = 1;
force LOG_STATICARMT = 300;
force LOG_STEALVEH = true;
force LOG_WARNDELAY = 15;
force LOG_WARNDIST = 800;

// MRH_MilsimTools - CAS Suppport
MRH_MilsimTools_CAS_DelayBetween = 120;
...
MRH_MilsimTools_LD_ShowLoadOutInBrief = true;
...
MRH_MilsimTools_DebugTools_DoLogDebugMode = true;
...
MRH_MilsimTools_Arty_DelayBetween = 60;
...
force MRH_MilsimTools_HaloGear_AADDefaultOpeningAltitude = "120";
...
force MRH_MilsimTools_InsertionHandler_SupplyPlanesBluFor = "B_Plane_Transport_01_infantry_F, B_VTOL_01_infantry_F";
...
MRH_MilsimTools_ST_BriefingRemote_overlay = "\MRHMilsimTools\Paa\cnn_news_ca.paa";
MRH_MilsimTools_ST_BriefingRemote_videosToPlay = "\a3\missions_f_bootcamp\video\vr_generictransition_1.ogv,\a3\missions_f_epa\video\a_in_intro.ogv";
