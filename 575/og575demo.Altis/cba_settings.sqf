...
force ace_medical_delayUnconCaptive = 10.5;
...
ace_medical_litterCleanUpDelay = 180.05;
...
force kat_aceAirway_deathTimer = 480;
force kat_aceAirway_enable = true;
force kat_aceAirway_probability_obstruction = 20;
force kat_aceAirway_probability_occluded = 20;
force kat_aceAirway_string_exit = "";

// KAT - ACE Breathing
force kat_aceBreathing_death_timer_enable = true;
force kat_aceBreathing_enable = true;
force kat_aceBreathing_pneumothorax = 5;
...
force kat_aceMisc_limitWounds_condition = 0;
...
MRH_MT_RHSCBPS_useGlobal = false;
...
force MRH_MilsimTools_FireSupport_CASShots = "999";
...
force MRH_MilsimTools_FireSupport_ArtyShots = "999";
...
MRH_MilsimTools_HaloGear_AADDefaultOpeningAltitude = "120";
...
MRH_MilsimTools_HaloGear_missionConfiguredProtectiveGear = "MRH_HaloMask,MRH_HaloMaskNoESS,RHS_jetpilot_usaf,rhs_zsh7a,rhs_zsh7a_alt,RHS_TU95MS_vvs_old";
MRH_MilsimTools_HaloGear_playRebreatherSounds = true;

// MRH_MilsimTools - Heli Taxi
MRH_MilsimTools_BluForCivs = "C_Heli_Light_01_civil_F";
MRH_MilsimTools_BluForHelis = "RHS_UH60M_d,RHS_MELB_MH6M,RHS_CH_47F";
MRH_MilsimTools_BluForInde = "I_Heli_Transport_02_F,I_Heli_light_03_unarmed_F";
MRH_MilsimTools_BluForOpFor = "O_Heli_Transport_04_bench_F,O_Heli_Light_02_unarmed_F,O_Heli_Transport_04_covered_F";
MRH_MilsimTools_Heli_ConditionIsFormLeader = false;
MRH_MilsimTools_Heli_CustomCondition = "[player, 'MRH_KeyCard_IND'] call BIS_fnc_hasItem;";
MRH_MilsimTools_Heli_isCustomConditionSet = true;
MRH_MilsimTools_Heli_NumberSimulTPerSide = "999";
MRH_MilsimTools_Heli_UseHeliTaxiInMission = true;
...
force MRH_MilsimTools_MEDEVAC_CustomCondition = "[player, 'MRH_KeyCard_IND'] call BIS_fnc_hasItem;";
force MRH_MilsimTools_MEDEVAC_DelayBetween = 120;
force MRH_MilsimTools_MEDEVAC_ESCORT_BluFor = "RHS_MELB_AH6M";
...
force MRH_MilsimTools_MEDEVAC_MEDICCLASS_BluFor = "B_mas_usl_recon_OPSTS_F";
...
force MRH_MilsimTools_InsertionHandler_SupplyPlanesBluFor = "RHS_C130J,NB_MV22";
...
MRH_MilsimTools_Roster_ShowAiWithinGrps = true;

// MRH_MilsimTools - Supply drops
force MRH_MilsimTools_FireSupport_NumberOfSuppliesDrops = "10";
...
force MRH_MilsimTools_FireSupport_SupplyPlanesBluFor = "RHS_C130J,NB_MV22";
...
force MRH_SAT_MaxSatAltitude = 500;
...
OPF_G_F = true;
OPF_T_F = true;
rhs_faction_msv = true;
rhs_faction_rva = true;
rhs_faction_socom = true;
rhs_faction_tv = true;
rhs_faction_usaf = true;
rhs_faction_usarmy_d = true;
rhs_faction_usarmy_wd = true;
rhs_faction_usmc_d = true;
rhs_faction_usmc_wd = true;
rhs_faction_vdv = true;
rhs_faction_vmf = true;
rhs_faction_vpvo = true;
rhs_faction_vv = true;
rhs_faction_vvs = true;
rhs_faction_vvs_c = true;
rhsgref_faction_cdf_air = true;
rhsgref_faction_cdf_air_b = true;
rhsgref_faction_cdf_ground = true;
rhsgref_faction_cdf_ground_b = true;
rhsgref_faction_chdkz = true;
rhsgref_faction_chdkz_g = true;
rhsgref_faction_hidf = true;
rhsgref_faction_nationalist = true;
rhsgref_faction_tla = true;
rhsgref_faction_un = true;
rhssaf_faction_airforce = true;
rhssaf_faction_airforce_opfor = true;
rhssaf_faction_army = true;
rhssaf_faction_army_opfor = true;
rhssaf_faction_un = true;
...
// NMAB Settings
force NMAB_setting_particlesEnabled = true;
...
force SSS_setting_slingLoadWhitelist = "B_LSV_01_unarmed_F,ACE_Box_82mm_Mo_Combo,ACE_medicalSupplyCrate_advanced,ACE_Box_Misc,B_supplyCrate_F";
force SSS_setting_specialItems = "MRH_KeyCard_IND";
...
force TFAR_Teamspeak_Channel_Name = "TaskForceRadio-Training";
