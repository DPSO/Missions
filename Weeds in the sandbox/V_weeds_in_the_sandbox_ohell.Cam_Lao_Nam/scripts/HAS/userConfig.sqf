...
RYD_HAS_CallerName = "Ghost";//name of the unit calling for airlift. Leave empty string for default: actual unit's name
RYD_HAS_AddHints = true;//if additional hint messsages should be displayed
...
RYD_HAS_ForceDescent = true;//should additional code enforce heli descent at last landing stage at destination until all disembark. May be useful, if heli's AI tend to go up too early. Use only, if necessary.
...
RYD_HAS_UseSupportsMenu = true;//if false = mouse actions will be used to call transport, supply, to cancel request or to change flight ceiling. When true - these actions will be available via supports menu (0-8). Destination choice actions will be always under mouse action menu. 
...
RYD_HAS_CruisingSpeed = 1;//maximal expected cruising speed for helicopters. Set below 10 for unlimited cruising speed and disabling slowing down at turning.
RYD_HAS_RespawnHelis = 300;//if positive, destroyed/immobilized HAS helicopter will be after 60 seconds replaced by new one, placed, where destroyed was placed when was added to HAS. Old one will be deleted along with the crew. Value represents number of respawns. 0 - disabled, -1 - unlimited
...
RYD_HAS_SignalClassesDay = //parent classes of ammo shot, that will be considered as proper position marker for pick up spot. Leave empty if no signal should be required - day
	...
	"vn_magazine_grenade_m18_g", 
	"vn_magazine_grenade_m18_p", 
	"vn_magazine_grenade_m18_r", 
	"vn_magazine_grenade_m18_w", 
	"vn_magazine_grenade_m18_y", 
	"vn_magazine_grenade_rdg2",
	"vn_m18_green_mag",
	"vn_m18_purple_mag",
	"vn_m18_red_mag",
	"vn_m18_white_mag", 
...
RYD_HAS_SignalClassesNight = //parent classes of ammo shot, that will be considered as proper position marker for pick up spot. Leave empty if no signal should be required - night
	...
	"FlareBase",
	"SmokeShellGreen",
	"vn_magazine_launcher_m129", 
	"vn_magazine_launcher_m128", 
	"vn_magazine_launcher_m127", 
	"vn_m127",
	"vn_m127_mag",
	"vn_m128_mag",
	"vn_m129_mag",
	"vn_magazine_ugl_40mm_m583_flare_w", 
	"vn_magazine_ugl_40mm_m661_flare_g", 
	"vn_magazine_ugl_40mm_m662_flare_r", 
	"vn_magazine_ugl_40mm_m695_flare_y"
	];
...
RYD_HAS_FastRopingLvl = 36;//optimal height for fast roping. Final level may be higher, if too tall obstacles present at destination
...
RYD_HAS_SupplyCall_ContainerClass = ["vn_b_ammobox_full_02", "vn_b_ammobox_full_10", "vn_b_ammobox_supply_01", "vn_b_ammobox_full_01"];//in fact, can be also any vehicle, but heli must be able to lift its weight. 
